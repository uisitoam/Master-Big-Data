...
\subsubsection{Gestión de ventas e inventario (proceso 1)}
...
\item \textbf{Medidas:} nombre y precio.
\begin{itemize}
\item nombre:
\item precio:
\end{itemize}
...
\subsubsection{Gestión financiera (proceso 2)}
...
\item \textbf{Tipo de tabla de hecho:} Hecho acumulativo.
\item \textbf{Medidas:} valoración del personal, valoración del ambiente y valoración de la comida.
\begin{itemize}
\item num\_valoraciones
\item valoracion\_personal:
\item valoracion\_ambiente:
\item valoracion\_comida:
\end{itemize}
\end{itemize}
