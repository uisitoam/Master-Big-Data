...
\begin{example}
    Veamos un ejemplo práctico de aplicación de la metodología CRISP-DM: centro de investigación enfocado en el uso de teledetección para evaluar la calidad del agua en las Rías. Diap - 60-65
\end{example}

\section{Key Performance Indicators (KPIs)}

Según Parmenter, los KPIs representan una serie de medidas en los aspectos más críticos en el desempeño organizacional para el éxito actual y futuro de la empresa. Para ello, se tienen los siguientes indicadores:
\begin{itemize}
\item \textbf{Key Goal Indicators (KGIs)}: se definen como objetivos medibles basados en objetivos amplios, tales como aumentar las ventas, mejorar la satisfacción del cliente, ... Los KGIs se definen como metas concretas.
\item \textbf{Critical Success Factors (CSFs)}: elementos necesarios para alcanzar los KGIs. Identifican las áreas clave a las que hay que prestar atención para llegar a las metas.
\item \textbf{KPIs} para medir el estado actual de los procesos de negocio relacionado con los CSFs. Ayudan a identificar el progreso hacia las metas y se suele dar en ratio o tanto por ciento.
\end{itemize}

\begin{example}
Supongamos que el objetivo es mejorar la salud. Algunos indicadores podrían ser:
\begin{itemize}
\item KGI: mejorar los resultados médicos.
\begin{itemize}
\item CSF1: dieta equilibrada.
\begin{itemize}
\item KPI: número de días por semana cumpliendo la dieta.
\end{itemize}
\item CSF2: actividad física regular.
\begin{itemize}
\item KPI: número de días por semana haciendo mínimo 30 minutos de ejercicio.
\end{itemize}
\item CSF3: bienestar emocional.
\begin{itemize}
\item KPI: número de horas de sueño diarias.
\end{itemize}
\end{itemize}
\end{itemize}
\end{example}
...
\begin{example}
Algunos indicadores para un negocio podrían ser:
\begin{itemize}
\item KGI: Aumentar las ventas un 10\%.
\begin{itemize}
\item CSF: aumentar las ventas netas por cliente.
\begin{itemize}
\item KPI: más del 30\% de los clientes han comprado accesorios de más de \$10.
\end{itemize}
\end{itemize}
\item KGI: Aumentar la satisfacción de los clientes en un 10\%.
\begin{itemize}
\item CSF3: dar una buena experiencia al cliente.
\begin{itemize}
\item KPI1: tasa de abandono de llamadas.
\item KPI2: tiempo de espera de llamadas.
\item KPI3: Disponibilidad de un servicio presencial.
\end{itemize}
\end{itemize}
\end{itemize}
\end{example}